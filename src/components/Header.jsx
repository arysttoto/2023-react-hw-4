...
function Header () {
    ...
    const toggleTheme = (isLight) => {          
      if (isLight) {
        ...
        document.querySelector(".toggle-theme-title").innerHTML = "Dark mode!"; 
      }
      else {
        document.documentElement.classList.add("dark");  
        document.querySelector(".toggle-theme-title").innerHTML = "Light mode!"; 
      }   
    }
          ...
          <div className="max-w-screen-xl px-4 py-3"> 
              <div className="flex items-center justify-between">
                  ...
                  <div className="flex links-and-buttons items-center"> 
                    ...
                    >
                      <span className="toggle-theme-title relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                          Dark mode!
                      </span>
                    </ Button> 
                    {/* <button
